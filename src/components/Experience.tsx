  ...
  return (
    <div id="experience" className="bg-gray-900 text-white p-4 sm:p-16">
      ...
      <div className="text-sm sm:text-lg leading-relaxed">
          ...
          <tbody>
            <tr>
              ...
              <td className="border px-2 sm:px-4 py-2">
                SCRUM team collaboration, Maintaining AQA structure, maintaining large scaled automation repository, generating E2E tests proactively, running pipelines regularly, pair programming, knowledge transfer, evaluating a11y tests periodically, gathering/discussing valuable test artifact(s) are some of my key responsibilities in this position.
              </td>
            </tr>
            <tr>
        ...
        <h2 className="text-3xl font-bold mb-4 mt-8">Education 📚</h2>
