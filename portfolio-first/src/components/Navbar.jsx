...
const Navbar = () => {
  ...
  return (
    <div
      className="fixed w-full h-[100px] flex justify-between px-4 bg-[#3c1053]
     text-gray-300 pt-4"
    >
      {/* menu */}
      ...
      <div
        className={
          !nav
            ? "hidden"
            : "absolute top-0 left-0 w-full h-screen bg-[#532877] flex flex-col justify-center items-center pt-08 ml-8"
        }
      >
        <ul>
        ...
        <ul>
          <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-blue-600">
            <a
              ...
              href="https://www.linkedin.com/in/mohan-shil/"
            >
          ...
          <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-blue-600">
            <a
              className="flex justify-between items-center w-full text-gray-300  "
              href="https://drive.google.com/file/d/1bsxSkpxLA6XorEGsAVtjg9oqIX2eO4WN/view?usp=drive_link"
            >
