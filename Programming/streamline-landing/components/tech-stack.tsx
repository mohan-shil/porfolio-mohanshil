...
const technologies = [
  ...
  { name: "Playwright", icon: "/tech/playwright.svg", category: "Testing" },
  { name: "Cypress", icon: "/tech/cypress.svg", category: "Testing" },
  { name: "WebdriverIO", icon: "/tech/webdriverio.svg", category: "Testing" },
  { name: "Selenium", icon: "/selenium-element.png", category: "Testing" },
  ...
  { name: "Java", icon: "/tech/java.svg", category: "Language" },
]
